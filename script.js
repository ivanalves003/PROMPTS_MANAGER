...
function openSidebar() {
  ...
  // esconde o botão de abrir quando a sidebar está visível
...
function closeSidebar() {
  ...
  // mostra o botão de abrir quando a sidebar está fechada
...
function createPromptItem(prompt) {
  ...
  return `
      ...
      <button class="btn-icon" title="Remover" data-action="remove">
        <img src="assets/assets/remove.svg" alt="Remover" class="icon icon-trash" />
      </button>
    </li>
  `
}
...
// Registra listener da lista apenas se o elemento existir
if (elements.list) {
...
function init() {
  load()
  renderList(elements.search ? elements.search.value : "")
  attachAllEditableHandlers()
  updateAllEditableStates()

  // Estado inicial: se for tela pequena, manter colapsada; caso contrário, aberta
  ...
  // opcional: ajustar comportamento ao redimensionar a janela
